import React, { useEffect, useState, useCallback }, { useEffect, useState, useCallback } from "react";
...
const ParentComponent: React.FC = () => {
  ...
  const { user, elevenLabsId } = useLoaderData<{ user: { id: string }; elevenLabsId: string }>();
  ...
  }, [conversation, coords, elevenLabsId]);
  ...
  return (
    <>
      <div className="flex flex-col items-center gap-4">
        <div className="fixed bottom-2 right-2 bg-zinc-50 text-slate-500 rounded-sm shadow-lg p-4 flex flex-col pointer-events-none pointer-events-none opacity-220">
      ...
      <div className="opacity-0 pointer-events-none pointer-events-none">
        <Transcript />
      </div>

      <MainButton
        className="fixed left-1/2 -translate-x-1/2 bottom-14 z-14 z-20"
